...
// Typing animation for hero title (removed to prevent HTML rendering issues)
// The title will display normally without typing animation

// Initialize page when loaded
window.addEventListener('load', () => {
    // Page is loaded, no typing animation needed
